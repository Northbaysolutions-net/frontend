...
export const getBrands = () => {
  ...
  return axios.get('http://localhost:3000/categories').then((results)=>{
     return results.data
...
export const getCartTotal = cartItems => {
    ...
    for(var i=0; i<cartItems.length; i++){
        total += parseFloat(cartItems[i].qty, 10)*parseFloat((cartItems[i].discounted_price), 10);
    }
    return total;
}
