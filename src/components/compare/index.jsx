...
import {removeFromCompare, addToCartUnsafe} from '../../actions'
...
class Compare extends Component {
    ...
    render (){
        ...
        const {Items, symbol, addToCartUnsafe, removeFromCompare} = this.props;
                                        ...
                                        <div key={index}>
                                            <div className="compare-part">
                                                ...
                                                <div className="btn-part">
                                                    <a href="javascript:void(0)" className="btn btn-solid" onClick={() => addToCartUnsafe(item, 1)}>add to cart</a>
                                                </div>
                                            </div>
                                        </div>
                                    )}
...
export default connect(
    mapStateToProps,
    {removeFromCompare, addToCartUnsafe}
)(Compare)