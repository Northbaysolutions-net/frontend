...
class FilterBar extends Component {
    ...
    render (){
        ...
        <h5>Showing Products {this.props.filters.page*this.props.products.length}-{this.props.products.length*(this.props.filters.page+1)} Result</h5>
                </div>
                ...
                <div className="product-page-filter">
                    <select onChange={(e) => this.filterByPrice(e.target.value)}>
