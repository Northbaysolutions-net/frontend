    ...
    render (){
        ...
        return (
            <div>
                {/*SEO Support*/}
                <Helmet>
                    <title>Shopmate | Cart List Page</title>
                </Helmet>
                {/*SEO Support End */}
                            ...
                            <div className="col-sm-12">
                                <table className="table cart-table table-responsive-xs">
                                    ...
                                    {cartItems.map((item, index) => {
                                        return (
                                        <tbody key={`cart${index}`}>
                                            <tr>
                                                <td>
                                                    <Link to={`${process.env.PUBLIC_URL}/left-sidebar/product/${item.product_id}`}>
                                                        <img src={'/assets/images/product_images/'.concat(item.image)} alt="" />
                                                    </Link>
                                                </td>
                                                <td><Link to={`${process.env.PUBLIC_URL}/left-sidebar/product/${item.product_id}`}>{item.name}</Link>
                                                    <div className="mobile-cart-content row">
                                                        ...
                                                        <div className="col-xs-3">
                                                            <h2 className="td-color">{symbol}{item.discounted_price}</h2>
                                                        </div>
                                                        <div className="col-xs-3">
                                                ...
                                                <td><h2>{symbol}{item.discounted_price}</h2></td>
                                                <td>
                                                    <div className="qty-box">
                                                        <div className="input-group">
                                                            <span className="input-group-prepend">
                                                                <button type="button" className="btn quantity-left-minus" onClick={() => this.props.decrementQty(item.product_id)} data-type="minus" data-field="">
