...
import {sagaFormatHandler} from '../utils/sagaActionHelpers'
...
export const receiveSingleProduct=sagaFormatHandler('RECEIVE_SINGLE_PRODUCT')
...
export function authenticate(payload) {
    return { type: types.AUTHENTICATE, payload };
  }